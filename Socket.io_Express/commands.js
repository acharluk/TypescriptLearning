...
module.exports = {
    ...
    'play': { description: "Runs a game from <a target='_blank' href='https://xyronlabs.github.io'>XyronLabs</a>", run(args) { return `<iframe width="800" height="480" src="https://xyronlabs.github.io/p5_${args[1]}/"></iframe>` } }
}